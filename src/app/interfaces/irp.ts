...
export interface GetGCATReqFileReqDto{
	reqIdR?:number;
	reqfileNameX?:string;
	reqfileTypeC?:string;
}
export interface SetGcatIllusFileReqDto{
	fileStatusCdCOld?:string;
	fileStatusCdCNew?:string;
	illstrIdR?:string;
	filePublishY?:string;
	plastIdC?:string;
...
export interface BrowseReqFileDto{
	statusCodeC?:string;
	illstrIdR?:string;
	fileContentTypeC?:string;
}

export interface ReqFileIo4Dto{
	reqIdR?:number;
	reqfileMarkedF?:string;
	reqfileTypeC?:string;
	reqfileNameX?:string;
...
export interface AddGcatWQReqDto{
	plastIdC?:string;
	illstrIdR?:string;
	reqIdR?:number
...
export interface SetGcatWQReqDto{
	plastIdC?:string;
	illstrIdR?:string;
	reqIdR?:number
	gtiwqKeyDataX?:string;
