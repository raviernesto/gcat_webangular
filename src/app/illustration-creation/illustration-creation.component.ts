...
@Component({
  selector: 'app-illustration-creation',
  templateUrl: './illustration-creation.component.html',
  styleUrls: ['./illustration-creation.component.css']
})
export class IllustrationCreationComponent implements OnInit {
