...
@Component({
  selector: 'app-illustration-status-rejtable',
  templateUrl: './illustration-status-rejtable.component.html',
  styleUrls: ['./illustration-status-rejtable.component.scss']
})
export class IllustrationStatusRejtableComponent implements OnInit {
  table1:any;
  user: String = "";
  cmdtype: String = "";
  sectgroup:String="";
  ...
  ngOnInit(): void {
    ...
    this.service.fetchRejIlluTable(Input1).subscribe((res: any) => {
            console.log(res);
      this.data = res;
