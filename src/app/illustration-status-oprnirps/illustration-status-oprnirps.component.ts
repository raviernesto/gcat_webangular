...
@Component({
  selector: 'app-illustration-status-oprnirps',
  templateUrl: './illustration-status-oprnirps.component.html',
  styleUrls: ['./illustration-status-oprnirps.component.scss']
})
export class IllustrationStatusOprnirpsComponent implements OnInit {
  table1:any;
  user: String = "";
  cmdtype: String = "";
  sectgroup:String="";
  ...
  ngOnInit(): void {
    ...
    this.service.fetchOpenIrpsTable(Input1).subscribe((res: any) => {
