...
@Component({
  selector: 'app-illustration-status-arttable',
  templateUrl: './illustration-status-arttable.component.html',
  styleUrls: ['./illustration-status-arttable.component.scss']
})
export class IllustrationStatusArttableComponent implements OnInit {
  table1:any;
  user: String = "";
  cmdtype: String = "";
  sectgroup:String="";
  ...
  ngOnInit(): void {
    ...
    this.service.fetchArtTable(Input1).subscribe((res: any) => {
